package dev.justchess.app.ui.about
...
import dev.justchess.app.SOURCE_URL
...
fun AboutScreen(onBack: () -> Unit) {
    ...
    val text = remember {
        buildString {
            ...
            appendLine("Review labels use on-device Stockfish centipawn/mate loss buckets, not Chess.com's model; accuracy is engine accuracy. Miss and Brilliant are transparent sacrifice/missed-punishment heuristics, not Chess.com labels.")
